...
Jednoczesne zajmowanie więcej niż jednego zasobu powoduje niepotrzebne obciążenia i może prowadzić do trudnych w wykryciu zakleszczeń. Aby zdiagnozować podwójne jednoczesne zajęcia zasobów? Można do klasy \tname{Resource} dostarczyć mutex owinięty w licznik ilości zastosowanych blokad w lokalnym wątku.
